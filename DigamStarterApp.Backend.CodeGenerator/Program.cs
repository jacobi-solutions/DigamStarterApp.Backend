...
class Program
{
    private const string _frontendAppName = "digam-starter-app.frontend";  // Name of your Angular project
    private const string _backendAppName = "DigamStarterApp.Backend";
    private const string _generatedApiFileName = "digam-starter-app-api.service.ts";
    private const string _generatedApiClassName = "DigamStarterAppApiService";
